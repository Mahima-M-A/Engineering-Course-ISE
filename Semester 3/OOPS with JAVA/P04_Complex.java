...
class P04_Complex
{
    ...
    P04_Complex(float real1,float img1,float real2,float img2) //to initialize the complex numbers
    {
        this.real1=real1;
        this.real2=real2;
        this.img1=img1;
    ...
    public static void main(String[] args)
    {
        ...
        P04_Complex ob=newP04_ Complex();
        ...
        P04_Complex ob1=new P04_Complex(ob.real1,ob.img1,ob.real2,ob.img2);
        ob1.add();
        ob1.subtract();
        ob1.multiply();
    }
